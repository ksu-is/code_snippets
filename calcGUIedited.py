...
class Application(Frame):
    ...
    def __init__(self, master):
        ...
        self.entry.grid(row=0, column=0, columnspan=4, sticky="w")
    ...
    def create_widgets(self):
        ...
        :return: None
        """
        logo_png = ImageTk.PhotoImage(Image.open("BinaryImage.png").resize((80,50)))
        self.logo = Label(self, image = logo_png, width=50, height=3)
        self.logo.grid(row=0, column=5, columnspan=2, sticky="w")
